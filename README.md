# ewm
#php mysql insert csv xlsx to mysql 
...
How to install ?
1) after create the database , open file 'config.php' and insert the database informations :
$DBhost = "";  	// your database hostname
$DBname = "";  		// your database name
$DBusername = ""; 		// your database username
$DBpassword = "";    	// your database password 

2) go to link : http://example.com/install.php , create the admin account . 
